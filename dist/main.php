      ...
      <i class="mdi mdi-github-circle"></i>
        ...
        <aside class="left-sidebar bg-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            <!-- Aplication Brand -->
            <div class="app-brand" style="background-color:#fff">
              <a href="main.php" title="Sleek Dashboard">
               <img src="assets/img/imos/logoImos.png" alt="" width="33" height="33">
                <span class="brand-name text-truncate" style="color:#5a0622">PANEL SAUT</span>
              </a>
            </div>
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard"
                      ...
                      <span class="nav-text">Captura</span> <b class="caret"></b>
                    </a>
                      ...
                      <div class="sub-menu">
                        <li>
                              <a class="sidenav-item-link" href="index.html">
                                <span class="nav-text">SAIP Y ARCO</span>
                            ...
                            <li >
                              <a class="sidenav-item-link" href="analytics.html">
                                <span class="nav-text">CONCENTRARO RECURSOS</span>
                            ...
                            <li >
                              <a class="sidenav-item-link" href="analytics.html">
                                <span class="nav-text">COMITE DE TRANSPARENCIA</span>
                            ...
                            <li >
                              <a class="sidenav-item-link" href="analytics.html">
                                <span class="nav-text">DENUNCIAS PUBLICAS</span>
                  ...
                  <li  class="has-sub" >
                    <a  href="calendar.html" aria-expanded="false" aria-controls="app">
                      <i class="mdi mdi-calendar"></i>
                      <span class="nav-text">CALENDARIO</span> <b class="caret"></b>
                    </a>
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#components"
                      ...
                      <span class="nav-text">METRICAS</span> <b class="caret"></b>
                    </a>
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#icons"
                      ...
                      <span class="nav-text">CATALOGOS</span> <b class="caret"></b>
                    </a>
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#forms"
                      ...
                      <span class="nav-text">CONSULTAS</span> <b class="caret"></b>
                    </a>
  </li>
                           </div>
            ...
            <nav class="navbar navbar-static-top navbar-expand-lg">
              ...
              <div class="navbar-right ">
                <ul class="nav navbar-nav">
                  ...
                  <!-- Cabecera trae nombre de usuario de base de datos -->
                  <?php 
                   include('funciones.php');
                   $sql = "select * from mosut_users where mosut_users_usuario = '".$user."' ";
                   $result = db_query($sql);
                   while($row = mysqli_fetch_object($result)){
                   ?>
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="assets/img/imos/logoImos.png" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block"><?php echo $row->mosut_users_usuario;?></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="assets/img/imos/logoImos.png" class="img-circle" alt="User Image" />
                        <div class="d-inline-block">
                   <?php echo $row->nombre; echo " ";echo $row->apellidoP?><small class="pt-1"><?php echo $row->correo;}?></small>
                        </div>
                      </li>

                      <li>
                        <a href="#">
                          <i class="mdi mdi-email"></i> Notificaciones
                        </a>
                      </li>
                     
                      <li class="right-sidebar-in">
                        <a href="javascript:0"> <i class="mdi mdi-settings"></i> Configuracion </a>
                      </li>

                      <li class="dropdown-footer">
                        <a href="logout.php"> <i class="mdi mdi-logout"></i> Salir </a>
                      </li>
                    </ul>
                  </li>
                </ul>
